...
public abstract class AbstractMobileActionsGenerator {
	...
	protected void addImports() {
		this.parser.addImport("sogeti.testing_framework_base.core.shared.execptions.application.CanNotPerformActionException");
		this.parser.addImport("sogeti.testing_framework_base.core.application.actions.mobile." + this.currentActionClass);
		this.parser.addImport("sogeti.testing_framework_base.utils.Logger");
	...
	private String getCodeForWaitUntilFirstElementsIsVisible(String elementsName) {
		...
		this.parser.addImport("sogeti.testing_framework_base.core.application.actions.mobile.MobileActions");
		/*
	...
	private void generateListMethods(String startName, String fieldName, 
		...
		String bodyMethod = "";
		String sufixMethodName = Utils.capitalizeWord(fieldName);
