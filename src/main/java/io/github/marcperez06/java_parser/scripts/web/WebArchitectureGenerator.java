...
import sogeti.testing_framework_base.core.application.drivers.Driver;
import sogeti.testing_framework_base.core.application.screen.web.Page;
...
import sogeti.testing_framework_base.core.shared.properties.keys.WebEnvProperties;
...
public class WebArchitectureGenerator {
	...
	private void addImportsForElements(List<String> imports) {
		...
		imports.add("org.openqa.selenium.WebDriver");
		imports.add("sogeti.testing_framework_base.core.shared.java_parser.scripts.web.WebActionsGenerator");
		imports.add("sogeti.testing_framework_base.core.application.screen.web.PageElements");
	}
	...
	private void addImportsForProcess(List<String> imports) {
		imports.add("sogeti.testing_framework_base.core.application.process.web.WebBaseProcess");
	}
