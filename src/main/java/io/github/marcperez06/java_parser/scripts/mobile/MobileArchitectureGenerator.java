...
import sogeti.testing_framework_base.core.application.devices.AndroidDevice;
import sogeti.testing_framework_base.core.application.devices.IOSDevice;
import sogeti.testing_framework_base.core.shared.extractor.tools.TestDataExtractor;
import sogeti.testing_framework_base.core.shared.extractor.tools.TestDataExtractorFactory;
...
import sogeti.testing_framework_base.core.shared.java_parser.objects.architecture.ArchitectureGeneratorData;
import sogeti.testing_framework_base.core.shared.properties.EnvironmentProperties;
import sogeti.testing_framework_base.core.shared.properties.PropertiesManager;
import sogeti.testing_framework_base.core.shared.properties.keys.MobileEnvProperties;
...
public class MobileArchitectureGenerator {
	...
	private void addImportsForActivity(List<String> imports) {
		//imports.add("sogeti.testing_framework_base.core.drivers.Driver");
		imports.add("io.appium.java_client.pagefactory.AppiumFieldDecorator");
		imports.add("org.openqa.selenium.support.PageFactory");
		imports.add("sogeti.testing_framework_base.core.application.screen.WebDriverManager");
	}
	...
	private void addImportsForElements(List<String> imports) {
		...
		imports.add("sogeti.testing_framework_base.core.shared.java_parser.scripts.mobile.MobileActionsGenerator");
		imports.add("sogeti.testing_framework_base.core.application.screen.mobile.ScreenElements");
	}
	...
	private void addImportsForActions(List<String> imports) {
		imports.add("sogeti.testing_framework_base.core.application.screen.WebDriverManager");
		//imports.add("sogeti.testing_framework_base.core.application.wait.Wait");
	...
	private void generateProcess() {
		...
		String variableName = Utils.uncapitalizeWord(this.className);
	...
	private void addImportsForProcess(List<String> imports) {
		imports.add("sogeti.testing_framework_base.core.application.process.mobile.MobileBaseProcess");
	}
