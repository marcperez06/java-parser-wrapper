package sogeti.testing_framework_base.core.shared.java_parser.scripts.cucumber;
...
import sogeti.testing_framework_base.core.shared.java_parser.scripts.cucumber.strategy.ApiStrategyCucumberTestGenerator;
import sogeti.testing_framework_base.core.shared.java_parser.scripts.cucumber.strategy.BaseStrategyCucumberTestGenerator;
import sogeti.testing_framework_base.core.shared.java_parser.scripts.cucumber.strategy.MobileStrategyCucumberTestGenerator;
import sogeti.testing_framework_base.core.shared.java_parser.scripts.cucumber.strategy.StrategyCucumberTestGenerator;
import sogeti.testing_framework_base.core.shared.java_parser.scripts.cucumber.strategy.WebStrategyCucumberTestGenerator;
import sogeti.testing_framework_base.utils.IOUtils;
import sogeti.testing_framework_base.utils.gherkin.GherkinParser;
import sogeti.testing_framework_base.utils.gherkin.objects.GherkinCriteria;
import sogeti.testing_framework_base.utils.gherkin.objects.GherkinObject;
import sogeti.testing_framework_base.utils.gherkin.objects.GherkinVariable;
...
public class CucumberGenerator {
	...
	private void createCucumberSteps(MyJavaParser parser, GherkinObject gherkin, List<GherkinCriteria> criteriaLines) {
		...
		for (GherkinCriteria criteria : criteriaLines) {
			...
			parser.addParametersToMethod(method, parameters);
	...
	public static void generateCucumberStepsFromDirectory(String featuresDirectory, String packageName, 
		...
		List<String> featuresPath = IOUtils.getListOfAbsolutePathsInDirectory(featuresDirectory);
